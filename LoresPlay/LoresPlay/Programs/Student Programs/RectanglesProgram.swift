...
class RectanglesProgram: Program {
    ...
    override func draw()  {
        drawRectangle(x1: 6, y1: 7, x2: 11, y2: 12, toColor: Color.Red)
        drawRectangle(x1: 21, y1: 3, x2: 29, y2: 5, toColor: Color.White)
        drawRectangle(x1: 29, y1: 5, x2: 34, y2: 11, toColor: Color.Yellow)
        drawRectangle(x1: 16, y1: 5, x2: 25, y2: 16, toColor: Color.Purple)
        drawRectangle(x1: 22, y1: 14, x2: 31, y2: 22, toColor: Color.MediumBlue)
        drawRectangle(x1: 16, y1: 20, x2: 25, y2: 28, toColor: Color.Orange)
        drawRectangle(x1: 23, y1: 26, x2: 30, y2: 30, toColor: Color.LightGray)
        drawRectangle(x1: 29, y1:19 , x2: 35, y2: 24, toColor: Color.Green)
